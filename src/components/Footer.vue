<template>
    <ul class="ml-1 mt-5 d-flex align-items-center footer-links" aria-label="Social media">
        <li>
            <a class="block hover:text-slate-200" href="https://www.linkedin.com/in/diether-llenares/" target="_blank" rel="noreferrer noopener" aria-label="LinkedIn (opens in a new tab)">
        ...
        <li>
            <a class="block hover:text-slate-200" href="https://github.com/dthrllnrs" target="_blank" rel="noreferrer noopener" aria-label="GitHub (opens in a new tab)">
